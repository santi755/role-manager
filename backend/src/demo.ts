...
async function bootstrap() {
    ...
    try {
        ...
        console.log(`  users:view → ${result.hasPermission ? '✓ GRANTED' : '✗ DENIED'} (${result.reason})`);
        ...
        console.log(`  users:edit → ${result.hasPermission ? '✓ GRANTED' : '✗ DENIED'} (${result.reason})`);
        ...
        console.log(`  users:delete → ${result.hasPermission ? '✓ GRANTED' : '✗ DENIED'} (${result.reason})`);
